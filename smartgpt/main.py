...
## Response Format: json
    ...
    {
        // Must have.Tasks are marked with [🔥] for the current task, [✅] for completed tasks, and [🕐] for future tasks.
        "plan": [   // Make sure all task IDs are ordered.
            "[🔥] 1. {TASK_DESCRIPTION}, actions required:(SearchOnline).", 
            ...   
            "[🕐] N. {TASK_DESCRIPTION}, actions required:(ExtractInfo), Depends on({task ids})",
            ... 
